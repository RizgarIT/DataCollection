<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Country.aspx.cs" Inherits="DataCollection.AdminDashboard.html.Country" %>
...
<asp:GridView ID="GridView1" class="table" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="3" DataSourceID="SqlDataSource2" ForeColor="Black" GridLines="Vertical" DataKeyNames="CountryName" Width="652px" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px">
    ...
    <SortedDescendingHeaderStyle BackColor="#383838" />
        ...
        <br />
                 <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="645px" AutoGenerateRows="False" CellPadding="4" DataKeyNames="CountryName" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" AllowPaging="True">
                     ...
                     <Fields>
                         <asp:BoundField DataField="CountryID" HeaderText="Country ID" SortExpression="CountryID" />
                         <asp:BoundField DataField="CountryName" HeaderText="Country Name" ReadOnly="True" SortExpression="CountryName" />
